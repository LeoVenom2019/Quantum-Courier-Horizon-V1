export const dashboardTranslations = {
  en: {
    ...
    route3End_route4Start: 'ENTRY INTO CHAPTER 4',
    ...
    route3End_projectEarthInitiated: '(Chapter 4 - New Earth initiated)',
    sector: 'Sector',
    cleared: 'CLEARED',
    lockedSector: 'LOCKED',
    ...
    aetherion: 'Aetherion',
    trip: 'Trip',
    cce: 'CCE - Câmara de Contenção de Etérion',
    cceConcept: 'Uma instalação altamente especializada que mantém o Etérion estável dentro de campos quânticos controlados.',
    aetherionConcept: 'Um combustível baseado em energia do vácuo quântico, capaz de dobrar o espaço-tempo ao redor da nave.',
    aetherionRequired: 'Etérion por Viagem',
    insufficientAetherion: 'Etérion insuficiente para manter a auto-entrega.',
    insufficientAetherionCaps: 'Cápsulas de Etérion insuficientes para o salto.',
    ...
    extractionTechConcept: 'Increases extraction of all mining in Chapter 2 by 10% per level.',
    doubleRoute: 'Double Route',
    doubleRouteConcept: 'Increases the value of deliveries for all Chapter 2 ships.',
    doomP: 'Doom P',
    ...
    capture: 'Capture',
    captureConcept: 'Increases QC capture in all Chapter 2 battles.',
    ...
    campaign: 'Campaign',
    campaignDesc: '(Saves campaign data from all chapters)',
    ...
    routeUnlocked: 'Delivery route unlocked:',
    ...
    earlyReturnChance: 'Return Chance',
    earlyReturnDesc: 'Chance to find a shortcut and finish the mission after 1 minute of travel.',
    ...
    tutorialRoutes2Title: 'Chapter 2 - Interstellar Routes Tutorial',
    ...
    route2UnlockTitle: 'Chapter 2 - Interstellar Routes Unlocked',
    route2UnlockedMessage: '🌌 Chapter 2 - Interstellar Routes Unlocked\n\nCongratulations, pilot. You have conquered the Solar System.\n\nThe campaign expands beyond the old solar economy. To begin this chapter, your local empire becomes legacy support for the colonies.\n\nCongratulations, you won the Pulsar 1, a level 1 ship to start your journey.\n\nReady for the next leap?',
    route2TransitionMessage: '🌌 Chapter 2 - Interstellar Routes Unlocked\n\nCongratulations, pilot. You have conquered the Solar System.\n\nThe campaign expands beyond the old solar economy. To begin this chapter, your local empire becomes legacy support for the colonies.\n\nCongratulations, you won the Pulsar 1, a level 1 ship to start your journey.\n\nReady for the next leap?',
    ...
    '10% Chance (5x)': '10% Chance (5x)',
    '15% Chance (5x)': '15% Chance (5x)',
    '20% Chance (5x)': '20% Chance (5x)',
    '25% Chance (5x)': '25% Chance (5x)',
    '35% Chance (5x)': '35% Chance (5x)',
    history: 'History',
    missions: 'Missions',
    ...
    startVoidProtocol: 'START PROJECT EARTH',
    route3UnlockDesc: 'Time is no longer what it used to be. Project Earth calls you into the Void.',
    route3UnlockedMessage: '🌌 Chapter 3 - Void Routes: Project Earth Unlocked\n\nThe universe has changed. Time has distorted.\n\nEarth is no longer only a protected memory. It has become a mission.\n\nReady for the Void?',
    ...
    gameStatsByRoute: 'Game Statistics by Chapter',
    ...
    mission4Desc: 'Visitar a aba "Capítulo 1 - Rotas Solares" e ler o minitutorial. Iniciar a primeira entrega manual!',
    ...
    robotRepairedHeader: 'Bobby Blue Restored',
    ...
    upgradeBattleShipDesc: 'Focused exclusively on the Chapter 3 / transition battle ship',
    upgradeRarity: 'Upgrade Rarity',
    rarityUpgraded: 'Rarity Upgraded Successfully!',
    repairButton: 'REPAIR',
    ...
    projectEarthGoals: 'Chapter 3 - Project Earth Goals',
    route3Goals: 'Chapter 3 - Project Earth Goals',
    route2Goals: 'Chapter 2 - Interstellar Goals',
    goals: 'Goals',
    ...
    unlockAllExtractionPoints: 'Unlock ALL extraction points',
    ...
    reachQC: 'Reach',
    total5000Deliveries: 'Total of 1500 deliveries',
    ...
    whySo: 'Why, so?',
    whySoDesc: 'Increases by 5x the value acquired from the Mining tab in Chapter 2.',
    trillion: 'trillion',
    billion: 'billion',
    ...
    sovereignOfVoid: 'Sovereign of the Void',
    ...
    humanitarianNeed: 'Humanitarian Need',
    inspirationLevel: 'Inspiration Level',
    voidPointsOfInterest: 'Void Points of Interest',
  ...
  pt: {
    ...
    route3End_route4Start: 'ENTRADA NO CAPÍTULO 4',
    ...
    route3End_projectEarthInitiated: '(Capítulo 4 - Nova Terra iniciado)',
    sector: 'Setor',
    cleared: 'LIMPO',
    ...
    aetherionConsumes: 'Consome 1 Etérion / 10s',
    rhse: 'Reator Heliosingular de Síntese Etérica (RHSE)',
    rhseConcept: 'Um reator avançado que recria Etérion artificialmente.',
    miningWaste: 'Resíduos de Mineração',
    solarEnergy: 'Energia Solar Filtrada',
    aetherionTubes: 'Tubos de Etérion Bruto',
    extractionTech: 'Tecnologia de Extração',
    extractionTechConcept: 'Aumenta a extração de toda a mineração do Capítulo 2 em 10% por nível.',
    doubleRoute: 'Rota Dupla',
    doubleRouteConcept: 'Aumenta o valor das entregas em todas as naves do Capítulo 2.',
    ...
    capture: 'Captação',
    captureConcept: 'Aumenta a captação de QC em todas as batalhas do Capítulo 2.',
    synthesize: 'Sintetizar Etérion',
    aetherionSynthesized: 'Etérion sintetizado com sucesso!',
    ...
    campaign: 'Campanha',
    campaignDesc: '(Salva os dados da campanha em todos os capítulos)',
    ...
    routeUnlocked: 'Rota de entrega desbloqueada:',
    ...
    earlyReturnChance: 'Chance de Retorno',
    earlyReturnDesc: 'Probabilidade de encontrar um atalho e concluir a missão após 1 minuto de viagem.',
    production: 'Produção',
    units: 'unidades',
    pack: 'pack',
    ...
    tutorialRoutes2Title: 'Tutorial do Capítulo 2 - Rotas Interestelares',
    ...
    route2UnlockTitle: 'Capítulo 2 - Rotas Interestelares Desbloqueado',
    route2UnlockedMessage: '🌌 Capítulo 2 - Rotas Interestelares Desbloqueado\n\nParabéns, piloto. Você conquistou o Sistema Solar.\n\nA campanha se expande além da velha economia solar. Para iniciar este capítulo, seu império local se torna apoio legado para as colônias.\n\nParabéns, você ganhou a Pulsar 1, nave de nível 1 para começar sua jornada.\n\nPreparado para o próximo salto?',
    route2TransitionMessage: '🌌 Capítulo 2 - Rotas Interestelares Desbloqueado\n\nParabéns, piloto. Você conquistou o Sistema Solar.\n\nA campanha se expande além da velha economia solar. Para iniciar este capítulo, seu império local se torna apoio legado para as colônias.\n\nParabéns, você ganhou a Pulsar 1, nave de nível 1 para começar sua jornada.\n\nPreparado para o próximo salto?',
    ...
    unlockAllExtractionPoints: 'Desbloquear TODOS os Pontos de Extração',
    ...
    reachQC: 'Alcançar',
    total5000Deliveries: 'Total de 1500 entregas',
    ...
    next: 'PRÓXIMO',
    startRoute3: 'INICIAR CAPÍTULO 3',
    search: 'Busca',
    ...
    whySo: 'Why, so?',
    whySoDesc: 'Aumenta em 5x o valor adquirido da aba Mineração no Capítulo 2.',
    trillion: 'trilhões',
    billion: 'bilhões',
    ...
    sovereignOfVoid: 'Soberana do Vazio',
    ...
    robotRepairedHeader: 'Bobby Blue Restaurado',
    repairProgress: 'Progresso do Reparo',
    repairDesc: 'Consuma recursos para restaurar os sistemas do robô.',
    robotGlitchedDialogue: 'O...lá... Che...fe. Fomos ata...ca...dos!...\nVo...cê es...tá bem?\nEu pre...ci...so de re...pa...ros...',
    robotRepairedDialogue: 'Obrigado, Chefe.\nSistemas restaurados.\n\nVamos continuar com o Protocolo Terra...\nMas antes...\nVingança.\n\nVamos derrotar TODOS!!',
    ...
    upgradeBattleShip: 'Melhorar Nave de Batalha',
    upgradeBattleShipDesc: 'Focado exclusivamente na nave de batalha do Capítulo 3 / transição',
    upgradeRarity: 'MELHORAR RARIDADE',
    rarityUpgraded: 'Raridade Melhorada com Sucesso!',
    ...
    startVoidProtocol: 'INICIAR PROJETO TERRA',
    route3UnlockDesc: 'O tempo já não é o mesmo. O Projeto Terra chama você para o Vazio.',
    route3UnlockedMessage: '🌌 Capítulo 3 - Rotas do Vazio: Projeto Terra Desbloqueado\n\nO universo mudou. O tempo se distorceu.\n\nA Terra deixou de ser apenas uma memória protegida. Agora ela é uma missão.\n\nPronto para o Vazio?',
    gameStatsByRoute: 'Estatísticas por Capítulo',
    ...
    claimed: 'Resgatado',
    ready: 'Pronto',
    unlockedRoute: 'Rota de Entrega Desbloqueada',
    ...
    upgradesCaps: 'MELHORIAS',
    projectEarthGoals: 'Metas do Capítulo 3 - Projeto Terra',
    route3Goals: 'Metas do Capítulo 3 - Projeto Terra',
    route2Goals: 'Metas do Capítulo 2 - Interestelar',
    goals: 'Metas',
    humanitarianNeed: 'Necessidade Humanitária',
    inspirationLevel: 'Nível de Inspiração',
    voidPointsOfInterest: 'Pontos de Interesse do Vazio',
