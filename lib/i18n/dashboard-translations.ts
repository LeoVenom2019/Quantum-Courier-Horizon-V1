export const dashboardTranslations = {
  en: {
    ...
    speedRunDesc: 'Reach the ultimate peak of Chapter 1! Buy and upgrade everything in the Solar Routes to complete the run.',
    total: 'Total',
  ...
  pt: {
    ...
    speedRunDesc: 'O Capítulo 2 fica desativado neste modo. Chegue ao fim do Capítulo 1 o mais rápido possível!',
    total: 'Total',
