...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  { id: 'void_boss_zero_defeated', name: 'Zero Absoluto', description: 'Derrote o Boss Zero, seja durante a invasão ou em uma batalha aleatória.', type: 'milestone', target: 1, icon: 'Skull' },
  { id: 'void_boss_1_defeated', name: 'Predador do Berçário', description: 'Derrote o Devorador Alpha.', type: 'milestone', target: 1, icon: 'Skull' },
  { id: 'void_boss_2_defeated', name: 'Sangue nas Estrelas', description: 'Derrote a Sanguessuga Estelar.', type: 'milestone', target: 1, icon: 'Skull' },
  { id: 'void_boss_3_defeated', name: 'Fim da Amálgama', description: 'Derrote o Colosso Amalgamado.', type: 'milestone', target: 1, icon: 'Skull' },
  { id: 'void_boss_4_defeated', name: 'Tentáculos no Abismo', description: 'Derrote o Kraken do Vazio.', type: 'milestone', target: 1, icon: 'Skull' },
  { id: 'void_boss_5_defeated', name: 'Titã Derretido', description: 'Derrote a Besta-Titã de Ferro.', type: 'milestone', target: 1, icon: 'Skull' },
  { id: 'void_boss_6_defeated', name: 'Mutação Extinta', description: 'Derrote o Horror Mutante.', type: 'milestone', target: 1, icon: 'Skull' },
  { id: 'void_boss_7_defeated', name: 'Coroa do Vazio', description: 'Derrote o Verme-Rei do Vazio.', type: 'milestone', target: 1, icon: 'Skull' },
  { id: 'void_boss_8_defeated', name: 'Caçador do Abismo', description: 'Derrote o Predador Abissal.', type: 'milestone', target: 1, icon: 'Skull' },
  { id: 'void_boss_9_defeated', name: 'Queda de um Deus', description: 'Derrote O Deus-Monstro do Vazio.', type: 'milestone', target: 1, icon: 'Skull' },
  ...
  { id: 'ne_land_search_perfect_defenses_10', name: 'Muralha Terrestre', description: 'Vença 10 defesas terrestres ou batalhas diretas da Nova Terra.', type: 'accumulative', target: 10, icon: 'Shield' },
  { id: 'ne_sea_search_perfect_defenses_10', name: 'Escudo Aéreo-Marítimo', description: 'Vença 10 defesas aéreo-marítimas ou batalhas diretas da Nova Terra.', type: 'accumulative', target: 10, icon: 'Shield' },
  ...
  { id: 'ne_horizon_level_50', name: 'Horizon Veterana', description: 'Alcance o level 50 com a Horizon.', type: 'milestone', target: 50, icon: 'Rocket' },
  { id: 'ne_horizon_level_100', name: 'Horizon Lendária', description: 'Alcance o level 100 com a Horizon.', type: 'milestone', target: 100, icon: 'Rocket' },
  { id: 'ne_horizon_battle_cards_6', name: 'Carga Completa', description: 'Equipe 6 cartas de batalha quaisquer na Horizon.', type: 'milestone', target: 6, icon: 'Cpu' },
  { id: 'ne_special_laser_10', name: 'Feixe do Horizonte', description: 'Use o especial Horizon Laser 10 vezes.', type: 'accumulative', target: 10, icon: 'Zap' },
  { id: 'ne_special_barrage_10', name: 'Barragem Horizon', description: 'Use o especial Horizon Barrage 10 vezes.', type: 'accumulative', target: 10, icon: 'Zap' },
  { id: 'ne_special_thor_10', name: 'Juramento Repetido', description: 'Use o especial Juramento de Thor 10 vezes.', type: 'accumulative', target: 10, icon: 'Zap' },
  { id: 'ne_special_blizzard_10', name: 'Nevasca Persistente', description: 'Use o especial Blizzard 10 vezes.', type: 'accumulative', target: 10, icon: 'Zap' },
  { id: 'ne_horizon_crit_90', name: 'Precisão Impossível', description: 'Alcance 90% de chance crítica com a Horizon.', type: 'milestone', target: 90, icon: 'TrendingUp' },
  { id: 'ne_horizon_stage_100', name: 'Céu Hostil 100', description: 'Alcance a fase 100 com a Horizon.', type: 'milestone', target: 100, icon: 'Sword' },
  { id: 'ne_horizon_stage_200', name: 'Céu Hostil 200', description: 'Alcance a fase 200 com a Horizon.', type: 'milestone', target: 200, icon: 'Sword' },
  { id: 'ne_missions_10', name: 'Operador de Campo', description: 'Complete 10 missões da Nova Terra.', type: 'accumulative', target: 10, icon: 'Trophy' },
  { id: 'ne_missions_40', name: 'Comando da Nova Terra', description: 'Complete 40 missões da Nova Terra.', type: 'accumulative', target: 40, icon: 'Trophy' },
  { id: 'ne_political_card_1', name: 'Primeiro Mandato', description: 'Adquira 1 carta política.', type: 'milestone', target: 1, icon: 'CheckCircle2' },
  { id: 'ne_political_cards_all', name: 'Conselho Completo', description: 'Adquira todas as cartas políticas.', type: 'milestone', target: 1, icon: 'CheckCircle2' },
  { id: 'ne_battle_card_1', name: 'Primeiro Arsenal', description: 'Adquira 1 carta de batalha.', type: 'milestone', target: 1, icon: 'Sword' },
  ...
  { id: 'ne_helicopter_intel_all', name: 'Arquivo Aéreo Completo', description: 'Encontre todos os 20 planos de guerra inimigos com o Aether.', type: 'milestone', target: 20, icon: 'HistoryIcon' },
  { id: 'ne_warden_maxed', name: 'Horizon Warden no Limite', description: 'Melhore totalmente o tanque Horizon Warden.', type: 'milestone', target: 25, icon: 'Shield' },
  { id: 'ne_tank_win_1', name: 'Primeira Linha Rompida', description: 'Vença uma batalha de tanque.', type: 'milestone', target: 1, icon: 'Shield' },
  { id: 'ne_tank_wins_10', name: 'Coluna Blindada', description: 'Vença 10 batalhas de tanque.', type: 'accumulative', target: 10, icon: 'Shield' },
  { id: 'ne_tank_intel_all', name: 'Arquivo Blindado Completo', description: 'Encontre todos os 20 planos de guerra inimigos com o Horizon Warden.', type: 'milestone', target: 20, icon: 'HistoryIcon' },
  { id: 'ne_neptune_maxed', name: 'Neptune no Limite', description: 'Melhore totalmente o submarino Neptune.', type: 'milestone', target: 30, icon: 'Globe' },
  { id: 'ne_poseidon_maxed', name: 'Poseidon no Limite', description: 'Melhore totalmente o submarino Poseidon.', type: 'milestone', target: 30, icon: 'Globe' },
  { id: 'ne_enemy_submarines_10', name: 'Caçador Submarino', description: 'Destrua 10 submarinos inimigos.', type: 'accumulative', target: 10, icon: 'Sword' },
  { id: 'ne_submarine_depth_10000', name: 'Abismo de 10.000m', description: 'Alcance 10.000 metros de profundidade com qualquer submarino.', type: 'milestone', target: 10000, icon: 'TrendingUp' },
];
