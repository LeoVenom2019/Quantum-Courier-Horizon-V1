---
name: qch-balance
description: Analyze QCH economy, combat, mining, upgrades, missions, route progression, and reward tuning. Use when Codex needs to review or change gameplay numbers in reducers, constants, game data, missions, ship stats, enemy stats, costs, production, cooldowns, or progression curves.
---
