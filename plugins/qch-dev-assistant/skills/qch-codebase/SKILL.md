---
name: qch-codebase
description: Understand and modify the QCH Next.js game codebase. Use when Codex needs to locate feature ownership, change React components, reducers, game state, translations, mini-games, routes, audio hooks, dashboard tabs, or project conventions inside D:\PROJETOS\QCH.
---
