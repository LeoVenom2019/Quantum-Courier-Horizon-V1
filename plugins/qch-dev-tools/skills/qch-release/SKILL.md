---
name: qch-release
description: Prepare QCH changes for GitHub or handoff. Use when the project workflow needs to review the worktree, protect ignored/private files, run lint/build checks, summarize changes, stage, commit, push, open a PR, or verify that QCH is ready to share.
---
